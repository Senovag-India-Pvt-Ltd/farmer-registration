...
public class ExternalUnitRegistrationController {
    ...
    public ResponseEntity<?> getPaginatedListWithJoin(
        ...
        public ResponseEntity<?> externalUnitReport(
                ...
                @RequestParam(defaultValue = "50") int pageSize) {
            try {
                byte[] reportBytes = externalUnitRegistrationService.externalUnitReport(
    ...
    public ResponseEntity<?> search(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(externalUnitRegistrationService.searchByColumnAndSort(searchWithSortRequest));
        return ResponseEntity.ok(rw);
    }
    @GetMapping("/get-all")
    @ApiResponses(value = {
    ...
    public ResponseEntity<?> getAllByActive(
        ...
        ResponseWrapper rw = ResponseWrapper.createWrapper(Map.class);
        rw.setContent(externalUnitRegistrationService.getAllByActive(isActive));
        return ResponseEntity.ok(rw);
    }
}
