...
//    public ReelerTypeMaster findByReelerNumberAndActive(String reelerNumber, boolean isActive);
    ...
    public List<Reeler> findByMobileNumberAndActive(String mobileNumber, boolean isActive);
...
//    );
    ...
    @Query(nativeQuery = true, value = """
            ...
            LEFT JOIN reeler_virtual_bank_account rvba ON rvba.reeler_id = r.reeler_id 
            WHERE 
                (:type = 'mobileNumber' AND r.mobile_number = :text) OR
                (:type = 'reelerNumber' AND r.reeler_number = :text) OR 
                (:type = 'reelerLicenseNumber' AND r.reeling_license_number = :text)
            """)
