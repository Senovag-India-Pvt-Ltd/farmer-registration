...
public class FarmerFamilyController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addFarmerFamilyDetails(@RequestBody FarmerFamilyRequest farmerFamilyRequest){
    ...
    public ResponseEntity<?> editFarmerFamilyDetails(
            @RequestBody final EditFarmerFamilyRequest editFarmerFamilyRequest
    ) {
