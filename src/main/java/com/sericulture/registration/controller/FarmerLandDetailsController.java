...
public class FarmerLandDetailsController {
    ...
    @PostMapping("/add")
    public ResponseEntity<?> addFarmerLandDetailsDetails(@RequestBody FarmerLandDetailsRequest farmerLandDetailsRequest){
    ...
    public ResponseEntity<?> editFarmerLandDetailsDetails(
            @RequestBody final EditFarmerLandDetailsRequest editFarmerLandDetailsRequest
    ) {
