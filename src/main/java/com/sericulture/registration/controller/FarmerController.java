...
public class FarmerController {
    ...
    @PostMapping("/updateFruitsId")
    public ResponseEntity<?> updateFruitsId(
            @Valid @RequestBody final EditCompleteFarmerRequest editFarmerRequest
    ) {
        ResponseWrapper<FarmerResponse> rw = ResponseWrapper.createWrapper(FarmerResponse.class);
        rw.setContent(farmerService.updateFruitsId(editFarmerRequest));
        return ResponseEntity.ok(rw);
    }
    ...
    public ResponseEntity<?> getPaginatedListWithJoin(
        ...
        public ResponseEntity<?> kaFarmersWithoutFruitsIdsReport(
            ...
            try {
                ...
                headers.add(HttpHeaders.CONTENT_DISPOSITION,
                        "attachment; filename=ka_farmers_report_" + Util.getISTLocalDate() + ".xlsx");
        ...
        public ResponseEntity<?> nonKaFarmersReport(
            ...
            try {
                ...
                HttpHeaders headers = new HttpHeaders();
                headers.add(HttpHeaders.CONTENT_DISPOSITION,
                        "attachment; filename=non_ka_farmers_report_" + Util.getISTLocalDate() + ".xlsx");
                headers.setContentType(MediaType.parseMediaType(
                        "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"));
